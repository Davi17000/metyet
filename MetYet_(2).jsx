...
.gc { display: flex; gap: 14px; align-items: flex-start; padding: 13px 2px;
  border-top: 1px solid var(--line-soft); }
.gc:first-of-type { border-top: 0; }
.gc.sec { padding: 10px 2px; }
...
.ai-results { margin-top: 14px; border: 1px solid var(--line); border-radius: 6px; max-height: 320px; overflow-y: auto; }
.ai-row { display: flex; align-items: center; gap: 12px; width: 100%; text-align: left; background: none;
  border: 0; border-bottom: 1px solid var(--line-soft); padding: 9px 12px; cursor: pointer; }
...
.ws-stock { flex: 0 0 auto; margin-right: 12px; padding-right: 12px; border-right: 1px solid var(--line-soft); }
.vt-stock { flex: 0 0 auto; margin-right: 12px; padding-right: 12px; border-right: 1px solid var(--line-soft); }
.cimg-row { display: flex; align-items: center; gap: 10px; min-width: 0; }
...
.ws-top { display: flex; gap: 16px; align-items: center; padding: 12px 16px; border-bottom: 1px solid var(--line);
...
.vt-evidence { display: flex; gap: 14px; padding: 4px 0 8px; }
...
const COLLECTORS_SEED = [
  { id: "c1", name: "Sarah Mendel", short: "Sarah M.", city: "Minneapolis, MN", since: "2024-06-02", last: "2026-08-05", prefs: ["charizard", "base-set", "shadowless", "first-edition", "psa9plus"], note: "Building a shadowless Base Set run. Buys fast when grade is right." },
  { id: "c2", name: "James Rivera", short: "James R.", city: "Austin, TX", since: "2024-09-14", last: "2026-08-01", prefs: ["vintage-wotc", "holo", "base-set", "neo"], note: "Wants the unlimited Base holo set complete before moving to Neo." },
  { id: "c3", name: "Alex Trinh", short: "Alex T.", city: "Seattle, WA", since: "2023-11-20", last: "2026-07-28", prefs: ["japanese", "eeveelution", "gold-star", "sealed"], note: "Japanese-first collector. Prefers raw Japanese over graded English." },
  { id: "c4", name: "Priya Raman", short: "Priya R.", city: "Chicago, IL", since: "2025-02-08", last: "2026-08-07", prefs: ["modern", "alt-art", "full-art", "trainer"], note: "Trainer supporter cards only. Very responsive to alt art drops." },
  { id: "c5", name: "Marcus Webb", short: "Marcus W.", city: "Atlanta, GA", since: "2024-01-17", last: "2026-07-30", prefs: ["team-rocket", "dark-pokemon", "base-set", "psa9plus"], note: "Team Rocket master set. Needs high grades only." },
  { id: "c6", name: "Dana Kowalski", short: "Dana K.", city: "Denver, CO", since: "2025-04-22", last: "2026-08-06", prefs: ["neo", "shining", "holo"], note: "Chasing all Shining Pokémon. Patient, pays well for centering." },
  { id: "c7", name: "Hiro Tanaka", short: "Hiro T.", city: "San Jose, CA", since: "2023-08-05", last: "2026-06-11", prefs: ["japanese", "promo", "gold-star", "eeveelution"], note: "Long-time client. Slow to reply but closes big when he does." },
  { id: "c8", name: "Ellen Fisher", short: "Ellen F.", city: "Boston, MA", since: "2025-06-30", last: "2026-08-08", prefs: ["trainer", "full-art", "sealed", "modern"], note: "Sealed modern + full art trainers. Buys in volume, small tickets." },
  { id: "c9", name: "Tomás Ortega", short: "Tomás O.", city: "Miami, FL", since: "2024-03-11", last: "2026-05-19", prefs: ["charizard", "vintage-wotc", "psa10", "holo"], note: "Charizard only. Has gone quiet since spring — worth a check-in." },
  { id: "c10", name: "Nina Alvarez", short: "Nina A.", city: "Portland, OR", since: "2025-01-25", last: "2026-08-02", prefs: ["eeveelution", "japanese", "alt-art", "modern"], note: "Eeveelution completist across eras." },
  { id: "c11", name: "Grant Whitfield", short: "Grant W.", city: "Nashville, TN", since: "2023-05-09", last: "2026-07-21", prefs: ["first-edition", "shadowless", "base-set", "sealed"], note: "1st Edition purist. Will wait years for the right copy." },
  { id: "c12", name: "Casey Lin", short: "Casey L.", city: "Brooklyn, NY", since: "2025-09-03", last: "2026-04-14", prefs: ["gold-star", "alt-art", "modern", "trainer"], note: "New-ish. Gold Star curiosity is turning into real intent." },
  { id: "c13", name: "Robert Nakamura", short: "Robert N.", city: "Honolulu, HI", since: "2023-02-14", last: "2026-07-15", prefs: ["japanese", "promo", "sealed", "vintage-wotc"], note: "Japanese sealed and tournament promos. Highest lifetime value." },
];
...
const COLLECTOR_CARDS_SEED = [
  ["t1", "c1", true, 275, PHOTOS("t1"), "PSA 70551201"],
  ["t2", "c1", true, 250, PHOTOS("t2"), "PSA 70551202"],
  ["t3", "c2", true, 320, PHOTOS("t3"), "PSA 69884410"],
  ["t4", "c2", false, 130, NO_PHOTOS, null],
  ["t5", "c3", true, 165, PHOTOS("t5"), "PSA 71230067"],
  ["t18", "c3", true, 200, NO_PHOTOS, "PSA 71230068"],
  ["t6", "c4", true, 195, PHOTOS("t6"), "PSA 72004511"],
  ["t7", "c4", true, 450, PHOTOS("t7"), "PSA 68110934"],
  ["t8", "c5", true, 760, PHOTOS("t8"), "PSA 66720188"],
  ["t9", "c6", true, 235, PHOTOS("t9"), "PSA 70998123"],
  ["t10", "c7", true, 980, PHOTOS("t10"), "PSA 65330472"],
  ["t11", "c8", false, 140, NO_PHOTOS, "PSA 73001284"],
  ["t12", "c9", true, 1500, PHOTOS("t12"), "PSA 64221900"],
  ["t17", "c9", true, 1180, PHOTOS("t17"), "PSA 67554120"],
  ["t13", "c10", true, 560, PHOTOS("t13"), "PSA 72880341"],
  ["t14", "c11", true, 430, PHOTOS("t14"), "PSA 69003377"],
  ["t15", "c12", true, 2050, PHOTOS("t15"), "PSA 63118845"],
  ["t16", "c13", true, 745, PHOTOS("t16"), "PSA 70442096"],
  ["t19", "c2", true, 190, PHOTOS("t19"), "PSA 69884411"],
  ["t20", "c2", true, 135, PHOTOS("t20"), "PSA 69884412"],
  ["t21", "c7", true, 160, PHOTOS("t21"), "PSA 65330473"],
  ["t22", "c7", true, 650, PHOTOS("t22"), "PSA 65330474"],
  ["t23", "c8", true, 360, PHOTOS("t23"), "PSA 73001285"],
  ["t24", "c8", true, 300, PHOTOS("t24"), "PSA 73001286"],
  ["t25", "c8", true, 505, PHOTOS("t25"), "PSA 73001287"],
  ["t26", "c8", true, 120, PHOTOS("t26"), "PSA 73001288"],
  ["t27", "c8", true, 75, PHOTOS("t27"), "PSA 73001289"],
];
...
export default function MetYet() {
  ...
  const [collectorCards, setCollectorCards] = useState(() =>
    COLLECTOR_CARDS_SEED.map((r, i) => ({ id: "cc" + i, cardId: r[0], collectorId: r[1], tpInterest: r[2], market: r[3], photos: r[4], cert: r[5] }))
  );
  ...
  const collectorFacts = useCallback(
    ...
    [collectorStats, goals, goalMatches, collector]
  );
  ...
  const setTradeInterest = (ccId, on) => {
    ...
    say(on ? "Flagged as a card you'd consider in trade." : "Removed from trade-eligible cards.");
  };
  ...
  const inviteCollector = (draft) => {
    const id = "c" + Date.now();
    setCollectors((cs) => [...cs, { id, name: draft.name, short: draft.name.split(" ")[0] + " " + (draft.name.split(" ")[1]?.[0] || "") + ".", city: draft.city, since: TODAY.toISOString().slice(0, 10), last: TODAY.toISOString().slice(0, 10), prefs: draft.prefs, note: draft.note, pending: true }]);
  ...
  const ctx = {
    ...
    collectorCards, setTradeInterest, attachBinderPhotos,
        ...
        <div className="panel">
          {rows.map((p, i) => (
            <div key={p.card.id} className="cv-row">
              ...
              <CardImage card={p.card} size="thumbnail" />
...
const CARD_IMAGE_SIZES = { thumbnail: 30, preview: 76, hero: 116 };
  ...
  return (
    <div className="vt-wrap">
          ...
          <SimBlock who={col.short}>
            {addable.length > 0 && (
              <div style={{ marginBottom: 9 }}>
                <div style={{ fontSize: 11.5, marginBottom: 5 }}>Add an eligible card — only cards you've flagged “Would consider” appear here.</div>
      ...
      <div style={{ marginTop: 9 }}>
        <button className="btn sm" onClick={() => { setDrawer(null); setNav({ section: "collectors", collectorId: opp.collectorId }); }}>
          Flag more of {col.short}'s cards
        </button>
      </div>
    </div>
  );
...
function StageWorkspace({ ctx, opp, goal, matches }) {
  const { card, collector, collectorCards, setDrawer, setNav, setModal,
  ...
  const eligible = collectorCards.filter((cc) => cc.collectorId === collectorId && cc.tpInterest);
        ...
        {opp.agreedPrice != null && opp.trade && <div className="kv"><span className="k">Cash balance</span><span className="v" style={{ fontSize: 12 }}>{cashLabel(opp, col.short)}</span></div>}
          {opp.stage === "agree-price" && (<>
            ...
            {opp.declined ? (
              ...
              <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" }}>
                <button className="btn pri sm" onClick={() => priceRespond(opp.id, "tp", "accept")}>Accept {money(last.amount)}</button>
                <AmountInput value={counter} onChange={setCounter} label="Counter"
                  disabled={!canCounter(opp.priceThread, "tp")}
                  onSubmit={() => { priceRespond(opp.id, "tp", "counter", Number(counter)); setCounter(""); }} />
              </div>
            ) : (
              <div className="faint" style={{ fontSize: 12.5 }}>Next step · Collector — {col.short} responds to your counter of {money(last.amount)}.</div>
            )}
              ...
              return (
                <tr key={r.k}>
                  ...
                  <td className="muted" style={{ fontSize: 12 }}>
                    ...
                    {/* which stage this sits in only matters when stages are mixed */}
                    {allStages && r.stageLabel && <span className="faint"> · {r.stageLabel}</span>}
...
function MyInventory({ ctx }) {
  ...
  const rows = useMemo(() => {
    ...
    if (era !== "all") r = r.filter(({ c }) => (era === "vintage" ? c.year < 2004 : c.year >= 2004));
    if (rel === "primary") r = r.filter(({ d }) => d.primary.length);
    if (rel === "none") r = r.filter(({ d }) => !d.primary.length && !d.secondary.length && !d.preference.length);
    if (rel === "any") r = r.filter(({ d }) => d.primary.length || d.secondary.length);
    r.sort((a, b) =>
      sort === "value" ? b.c.value - a.c.value
        : sort === "name" ? a.c.name.localeCompare(b.c.name)
          : (b.d.primary.length * 100 + b.d.secondary.length * 10 + b.d.preference.length) - (a.d.primary.length * 100 + a.d.secondary.length * 10 + a.d.preference.length)
    );
    return r;
  }, [activeInv, card, demandFor, q, era, rel, sort, filter]);
    ...
    <>
      ...
      <div className="panel" style={{ marginBottom: 14 }}>
        <div className="ph" style={{ gap: 8, flexWrap: "wrap" }}>
          ...
          <select className="inp" style={{ width: 130 }} value={era} onChange={(e) => setEra(e.target.value)}>
            <option value="all">All eras</option><option value="vintage">Vintage (pre-2004)</option><option value="modern">Modern</option>
          </select>
          <select className="inp" style={{ width: 190 }} value={rel} onChange={(e) => setRel(e.target.value)}>
            <option value="all">All relevance</option><option value="primary">Matches a primary goal</option>
            <option value="any">Matches any goal</option><option value="none">No network relevance</option>
          </select>
          <select className="inp" style={{ width: 150 }} value={sort} onChange={(e) => setSort(e.target.value)}>
            <option value="demand">Sort by demand</option><option value="value">Sort by value</option><option value="name">Sort by name</option>
          </select>
...
function InventoryRow({ ctx, inv, c, d }) {
  ...
  const tiers = [
    { key: "primary", label: "Primary Goals", cls: "p1", people: d.primary.map((g) => ({ id: g.collectorId, note: g.note })) },
    { key: "secondary", label: "Secondary Goals", cls: "p2", people: d.secondary.map((g) => ({ id: g.collectorId })) },
  ];
  const total = d.primary.length + d.secondary.length;
      ...
      <div style={{ borderTop: "1px solid var(--line-soft)", background: "#FCFDFD", padding: "9px 14px" }}>
        {total === 0 ? (
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
            {tiers.map((t) => t.people.length > 0 && (
              <div key={t.key} style={{ display: "flex", gap: 10, alignItems: "baseline" }}>
                <span className={"t-pill " + t.cls} style={{ flex: "0 0 128px" }}>
                  {t.label} <span className="mono" style={{ letterSpacing: 0 }}>{t.people.length}</span>
                </span>
                <div style={{ display: "flex", flexWrap: "wrap", gap: 5, flex: 1 }}>
                  {(open ? t.people : t.people.slice(0, t.key === "preference" ? 6 : 8)).map((p, i) => (
                    <button key={p.id + i} className="chip act" title={p.note || ""} onClick={() => setNav({ section: "collectors", collectorId: p.id })}>
                      {collector(p.id)?.short}
                    </button>
                  ))}
                  {!open && t.people.length > (t.key === "preference" ? 6 : 8) && (
                    <button className="chip act" onClick={() => setOpen(true)}>+{t.people.length - (t.key === "preference" ? 6 : 8)} more</button>
                  )}
                </div>
                <button className="btn sm" onClick={() => setModal({ type: "outreach", cardId: c.id, tier: t.key })}>Reach out</button>
              </div>
            ))}
          </div>
        )}
        ...
        {d.preference.length > 0 && (
          <div style={{ marginTop: total ? 9 : 0, paddingTop: total ? 8 : 0, borderTop: total ? "1px solid var(--line-soft)" : 0 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 12, color: "var(--faint)" }}>
              ...
              <button className="link" style={{ fontSize: 11.5 }} onClick={() => setWhyOpen(!whyOpen)} aria-expanded={whyOpen}>
...
const NET_COLUMNS = [
  { h: "Collector", val: (r) => r.c.name, text: true },
  // sorts on the stored date, never the formatted tenure string
  { h: "Member since", val: (r) => -new Date(r.f.memberSince).getTime(), num: true },
  { h: "Completed deals", val: (r) => r.f.completedDeals, num: true },
  { h: "Deal value", val: (r) => (r.f.completedDeals === 0 ? null : r.f.dealValue), num: true },
  { h: "Coverage", val: (r) => r.f.coverage, num: true },
];
    ...
    <>
      <div className="panel" style={{ marginBottom: 14 }}>
        ...
        <table className="tbl">
          ...
          <tbody>
            {rows.length === 0 && (
              <tr><td colSpan={5} className="empty">No collectors match that search.</td></tr>
            )}
            {rows.map(({ c, f }) => {
              return (
                <tr key={c.id}>
                  ...
                  <td className="num mono" style={{ fontSize: 13 }}>{f.completedDeals}</td>
...
function GoalCard({ ctx, g, tier }) {
  ...
  return (
    <div className={"gc" + (tier === "secondary" ? " sec" : "")}>
      <CardImage card={c} size={tier === "primary" ? "preview" : "thumbnail"} />
...
function CollectorProfile({ ctx, id }) {
  const { collector, collectorStats, collectorFacts, card, setNav, setModal, setDrawer, activity, opps } = ctx;
  const c = collector(id);
  const s = collectorStats(id);
  ...
  return (
    <>
      ...
      {/* D. Active Opportunities — a doorway, not a second Opportunities product.
      ...
      {/* E. History — one quiet line, with the existing activity behind it. */}
      <div className="cp-sec">
      ...
      {!picked ? (
        ...
        <>
          <div className="ac-id">
            ...
            <div className="cimg-row" style={{ alignItems: "flex-start", gap: 12 }}>
              <CardImage card={picked} size="preview" />
              <div style={{ minWidth: 0 }}>
